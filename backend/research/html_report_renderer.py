"""HTML report renderer for qualitative research reports."""
...
class HTMLReportRenderer:
    """Renders a structured qualitative research report dict to a self-contained HTML page."""
    ...
    def _section_persona_cards(self, voices: List[Dict]) -> str:
        ...
        for v in voices:
            ...
            if purchase_score is not None or purchase_intent_cn:
                ...
                score_display = f"{float(purchase_score):.1f}" if purchase_score is not None else "N/A"
                parts.append(
    ...
    def _wrap_page(self, title: str, body: str, meta: Dict) -> str:
        ...
        latency_sec = f"{latency / 1000:.1f}" if latency else "N/A"
...
<body>
{body}
<footer>Generated by MiMo Research Agent · Pipeline latency {latency_sec}s</footer>
</body>
</html>"""
